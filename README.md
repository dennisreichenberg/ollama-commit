...
Every AI commit tool I found either required an OpenAI API key, sent your diff to the cloud, or cost money per commit. If you already run Ollama locally, you have everything you need — this tool just wires it up to `git diff --staged`.
